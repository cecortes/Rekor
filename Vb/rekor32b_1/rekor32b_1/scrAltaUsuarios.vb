Public Class scrAltaUsuarios
    ...
    Private Sub btnSaveClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveClose.Click
        ...
        If _varglobal.ip = "" Or _varglobal.pass = "" Or _varglobal.user = "" Then
            MessageBox.Show("Por favor revise los parámetros de conexión y de click en Guardar." & vbNewLine & "" & vbNewLine & "Dirección IP (default): 192.168.1.92" & vbNewLine & "Usuario (default): root" & vbNewLine & "Contraseña (default): ZMalqp10", "Rekors CPU 32bits", MessageBoxButtons.OK, MessageBoxIcon.Stop)
        ...
        If txtIdCasas.Text = "" Then
            MessageBox.Show("El campo de Casa no puede estar vacío", "Rekor 32bits", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If

        If txtTelCasa.Text = "" Then
            MessageBox.Show("El campo de Teléfono Casa no puede estar vacío", "Rekor 32bits", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If

        If txtTelCel.Text = "" Then
            MessageBox.Show("El campo de Teléfono Celular no puede estar vacío", "Rekor 32bits", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
        ...
        If conexion.insertarDatos(datos) Then
            MessageBox.Show("Datos Guardados", "Rekor 32bits", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
            MessageBox.Show("Datos no guardados", "Rekor 32bits", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
