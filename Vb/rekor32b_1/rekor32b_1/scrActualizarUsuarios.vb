Public Class scrActualizarUsuarios
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        If conexion.actualizarUsuario(datos) Then
            MessageBox.Show("Usuario actualizado correctamente !!!", "Rekor 32bits", MessageBoxButtons.OK, MessageBoxIcon.Information)
            'Actualizamos los datos que se muestran en el data grid view y limpiamos los text box
            limpiar_actualizar()
        Else
            MessageBox.Show("El usuario no pudo actualizarse en la base de datos", "Rekor 32bits", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
