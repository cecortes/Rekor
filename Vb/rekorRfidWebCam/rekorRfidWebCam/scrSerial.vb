Public Class scrSerial
    ...
    Private Sub btnDeterminarPuertos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeterminarPuertos.Click
        ...
        If cmbPorts.Items.Count > 0 Then
            ...
            MessageBox.Show("Por favor seleccione el puerto serial y de click en Guardar." & vbNewLine & "" & vbNewLine & "Puerto Serial (Por defecto): COM3" & vbNewLine & "" & vbNewLine & "Puede revisar en el administrador de dispositivos para saber el nombre del puerto serial.", "Rekór RFID & WebCam", MessageBoxButtons.OK, MessageBoxIcon.Information)
        ...
        Else
            ...
            MessageBox.Show("No se encontró ningún puerto disponible." & vbNewLine & "" & vbNewLine & "Verifique que el dispositivo está conectado y consulte al soporte técnico.", "Rekór RFID & WebCam", MessageBoxButtons.OK, MessageBoxIcon.Error)
            cmbPorts.Enabled = False
            btnGuardarPto.Enabled = False
